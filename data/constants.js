...
const getStatText = (statType) => {
 ...
 else if(statType === "converts%ofdamagedealtintopethealth+%ofdamagedealthintopethealth") {return {type: "Converts % of Damage Dealt into Pet Health", preText: '+', postText: '% of Damage Dealth into Pet Health'}}
 else if(statType === "healthregeneration+%ofmaxhealth/sec") {return {type: "Health Regeneration", preText: '+', postText: '% of Max Health/sec'}}
 else if(statType === "damagereflectedbypet+%") {return {type: "Damage Reflected By Pet", preText: '+', postText: '%'}}
 ...
 else if(statType === "petdamagereduction+%") {return {type: "Pet Damage Reduction", preText: '+', postText: '%'}}
 else if(statType === "pethealthregeneration+%ofmaxpethealth") {return {type: "Pet Health Regeneration", preText: '+', postText: '% of Max Pet Health'}}
 ...
 else if(statType === "grenadecriticalhitchance+%") {return {type: "Grenade Critical Hit Chance", preText: '+', postText: '%'}}
 else if(statType === "reloadspeed+%") {return {type: "Reload Speed", preText: '+', postText: '%'}}
 else if(statType === "reloadspeed+%") {return {type: "Reload Speed", preText: '+', postText: '%'}}
 ...
 else if(statType === "bonusdamageasshock+%ofdamagedealt") {return {type: "Bonus Damage As Shock", preText: '+', postText: '% of damage dealt'}}
 else if(statType === "gundamage+%") {return {type: "Gun Damage", preText: '+', postText: '%'}}
 ...
 else if(statType === "maxshields+%") {return {type: "Max Shields", preText: '+', postText: '%'}}
 else if(statType === "shieldrechargerate+%") {return {type: "Shield Recharge Rate", preText: '+', postText: '%'}}
 else if(statType === "shieldrechargedelay-%") {return {type: "Shield Recharge Delay", preText: '-', postText: '%'}}
 else if(statType === "reloadspeed+%") {return {type: "Reload Speed", preText: '+', postText: '%'}}
 else if(statType === "movementspeed+%") {return {type: "Movement Speed", preText: '+', postText: '%'}}
